...
* **Reglas y Proceso:**
  ...
  * **Puntaje Final:** Base - Penalización + Bonificaciones (limitado a un mínimo de 0).
  * **Nivel:** 0–29 Principiante; 30–49 Básico; 50–69 Intermedio; 70–89 Avanzado; 90 o más Experto.
  * **Condiciones especiales:** Si existió copia, el estado final es "Descalificado". Si el puntaje es alto (>= 70) con demasiados errores (>= 5), se emite la observación: "Resultado inconsistente: revisar calidad de resolución".
...
* **Reglas y Proceso:**
  ...
  * **Condiciones especiales:** Si el avance real es menor al 60%, la calificación máxima permitida se degrada a Aprobado (no puede ser Excelente). Si la nota final es >= 7 sin documentación entregada, se genera la observación: "Buen producto, pero mala formalidad".
